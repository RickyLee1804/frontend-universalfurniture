...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Bisa tambahkan validasi sederhana di sini
    if (email && password) {
      ...
      <div className="login-form">
        <div className="form-content">
          ...
          <h2 className="form-title">
            Sistem Informasi Manajemen Universal Furniture
          </h2>
              ...
              <div className="input-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18,8h-1V6c0-2.76-2.24-5-5-5S7,3.24,7,6v2H6c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V10
                           C20,8.9,19.1,8,18,8z M12,17c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2S13.1,17,12,17z 
                           M15.1,8H8.9V6c0-1.71,1.39-3.1,3.1-3.1c1.71,0,3.1,1.39,3.1,3.1V8z" />
                </svg>
              </div>
            </div>
          </div>

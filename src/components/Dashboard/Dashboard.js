...
const Dashboard = () => {
  ...
  // Data untuk chart
  const chartData = [
    { day: '01', lastMonth: 3, lastWeek: 2 },
    { day: '02', lastMonth: 4, lastWeek: 3 },
    { day: '03', lastMonth: 5, lastWeek: 4 },
    { day: '04', lastMonth: 6, lastWeek: 3 },
    { day: '05', lastMonth: 7, lastWeek: 5 },
    { day: '06', lastMonth: 8, lastWeek: 6 },
    { day: '07', lastMonth: 9, lastWeek: 7 },
    { day: '08', lastMonth: 6, lastWeek: 5 },
    { day: '09', lastMonth: 8, lastWeek: 6 },
        ...
        <div className="calendar-section-bottom">
          ...
          <div className="calendar-month">
            <div className="month-nav">
              <ChevronLeft className="month-arrow" />
              <p className="month-title">September 2024</p>
              <ChevronRight className="month-arrow" />
            </div>
          </div>
